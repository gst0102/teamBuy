...
class Settings:
    ...
    wecom_archive_pull_limit: int = env_int("WECOM_ARCHIVE_PULL_LIMIT", 100)
    ...
    ocr_tesseract_bin: str = env_value("OCR_TESSERACT_BIN", "tesseract")
    ocr_mock_text: str = env_value("OCR_MOCK_TEXT", "")
